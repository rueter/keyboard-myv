.. -*- mode: rst -*-
==========================================
 Keyboards for the Erzya language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Erzya language. The data and implementations
...
* https://giellalt.uit.no/tools/docu-myv-manual.html
...
The Erzya keyboard sources can be acquired using the `Giella SVN
